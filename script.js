...
var nav_up = doc.getElementsByClassName('js-up'),
    ...
    nav_down_down = doc.getElementsByClassName('js-down-down');
...
nav_down_down[0].addEventListener('click', moveDownDown);
